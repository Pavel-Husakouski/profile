...
| Exadel | Lead Software Engineer | `Jun 2013 – Jul 2023` |
| VPI Systems Inc. | Senior Software Developer | `Feb 2001 – May 2013` |

Проверить построчно: именно эти три даты расходятся с резюме. Если в профиле стоит что-то вроде
`Sep 2010 – Present` у Exadel — это и есть та ошибка, из-за которой резюме и профиль читаются
как две разные биографии.
...
- [ ] Даты трёх ролей совпадают с `cv.md` до месяца.
- [ ] Ни одного названия NDA-продукта.
